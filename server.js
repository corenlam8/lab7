...
app.get('/player_info/post', function(req,res) {
  var player_id='select id, name from football_players;';
  var footballplayer=req.query.player_choice;
  var players= "select * from football_players where id = '"+ footballplayer + "';";
  var games_played= "select count(*) from football_games where '" + footballplayer +"' = any(players);";
  db.task('get-everything', task=>{
    return task.batch ([
      task.any(player_id),
      task.any(players),
